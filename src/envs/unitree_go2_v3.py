"""
    Unitree Go2 Environment:
        Playground formulation using only the yaw rate in observation
        with more noise in gravity vector and old stand still reward.
"""
...
class UnitreeGo2Env(PipelineEnv):
    ...
    def get_observation(
        ...
        noisy_yaw_rate = noisy_angular_rate[-1]
